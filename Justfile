...
pro-pressure-source-matrix-smoke output="artifacts/audio_qa/local-pro-pressure-source-matrix":
    ...
    jq -e 'any(.cases[]; .pressure_lift_policy.source_family == "sparse_bass_pressure" and .proof.bass_movement_source_derived == 1.0 and .proof.sparse_bass_movement_static_distance_hz >= 1.75 and .proof.sparse_bass_movement_frequency_span_hz >= 15.0 and .proof.sparse_bass_movement_span_margin_hz >= 0.0 and .proof.pressure_low_band_lift_ratio >= 1.70 and .proof.sparse_pressure_low_band_share >= 0.32 and .proof.sparse_pressure_low_to_mid_ratio >= 2.10 and .proof.strongest_audible_element == "bass" and .proof.strongest_audible_element_margin >= 0.12)' "{{output}}/source-matrix-report.json"
