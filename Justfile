...
pro-pressure-source-matrix-smoke output="artifacts/audio_qa/local-pro-pressure-source-matrix":
    ...
    jq -e 'any(.cases[]; .pressure_lift_policy.source_family == "sparse_bass_pressure" and .proof.bass_movement_source_derived == 1.0 and .proof.sparse_bass_movement_static_distance_hz >= 0.50 and .proof.sparse_bass_movement_frequency_span_hz >= 2.0)' "{{output}}/source-matrix-report.json"
...
professional-source-wav-pack-smoke output="artifacts/audio_qa/local-professional-source-wav-pack":
    ...
    jq -e 'any(.cases[]; .source_family == "sparse_bass_pressure" and .proof.bass_movement_source_derived == 1.0 and .proof.sparse_bass_movement_static_distance_hz >= 0.50 and .proof.sparse_bass_movement_frequency_span_hz >= 2.0)' "{{output}}/professional-source-wav-pack.json"
