...
pro-pressure-source-matrix-smoke output="artifacts/audio_qa/local-pro-pressure-source-matrix":
    ...
    jq -e 'any(.cases[]; .pressure_lift_policy.source_family == "sparse_bass_pressure" and .proof.bass_movement_source_derived == 1.0 and .proof.sparse_bass_movement_static_distance_hz >= 0.25 and .proof.sparse_bass_movement_frequency_span_hz >= 2.0)' "{{output}}/source-matrix-report.json"
...
professional-source-wav-pack-smoke output="artifacts/audio_qa/local-professional-source-wav-pack":
    ...
    jq -e 'any(.cases[]; .source_family == "sparse_bass_pressure" and .proof.bass_movement_source_derived == 1.0 and .proof.sparse_bass_movement_static_distance_hz >= 0.25 and .proof.sparse_bass_movement_frequency_span_hz >= 2.0)' "{{output}}/professional-source-wav-pack.json"
...
professional-output-suite-smoke output="artifacts/audio_qa/local-professional-output-suite":
    ...
    jq -e '.schema == "riotbox.professional_output_suite.v1" and .result == "pass" and .agent_verdict == "agent_promising" and .human_verdict == "unverified" and .evidence_role == "suite_diagnostic" and .scripted_generation == true and .quality_proof == false and .child_report_count == 8 and .passed_child_report_count == 8 and .failed_child_report_count == 0 and (.children | length) == 8 and all(.children[]; .result == "pass" and .agent_verdict == "agent_promising" and .human_verdict == "unverified" and .scripted_generation == true and .quality_proof == false and (.report_sha256 | length == 64)) and (.children | map(.id) | sort == ["dense_break", "destructive_variation", "edge_source_professional_diagnostics", "non_dense_professional_proof_pack", "pro_pressure_source_matrix", "professional_output_listening_pack", "professional_source_wav_pack", "rendered_weak_professional_outputs"]) and any(.children[]; .id == "professional_output_listening_pack" and .key_metrics.demo_reason_count == 3 and .key_metrics.not_demo_ready_reason_count == 3) and any(.children[]; .id == "edge_source_professional_diagnostics" and .key_metrics.case_count == 2 and .key_metrics.weak_routed_case_count == 2 and .key_metrics.source_families == ["bad_timing", "pad_noise"] and (.key_metrics.pressure_policy_families | index("pad_noise")) and (.key_metrics.pressure_policy_families | index("bad_timing")) and .key_metrics.pad_noise_texture_source_derived_count == 1 and .key_metrics.min_pad_noise_texture_candidate_count >= 3.0 and .key_metrics.min_pad_noise_texture_gate_static_distance_frames >= 256.0 and .key_metrics.min_pad_noise_texture_stab_static_distance_frames >= 256.0 and .key_metrics.min_pad_noise_texture_gate_stab_distance_frames >= 512.0 and .key_metrics.min_pad_noise_texture_transient_ratio >= 0.72 and (.key_metrics.weak_output_signals | index("pad_noise_policy_path")) and (.key_metrics.weak_output_signals | index("bad_timing_cautious_arrangement_path")) and (.key_metrics.proposed_fix_categories | index("source_selection")) and (.key_metrics.proposed_fix_categories | index("ui_cue"))) and .listening_identity.result == "pass" and .listening_identity.case_count == 3 and (.listening_identity.source_families == ["dense_break", "sparse_bass_pressure", "tonal_hook"]) and all(.listening_identity.cases[]; .demo_readiness == "unverified" and (.demo_worthy_reason | startswith("Worth review:")) and (.not_demo_worthy_reason | startswith("Not demo-ready yet:")))' "{{output}}/professional-output-suite.json"
    jq -e 'any(.children[]; .id == "dense_break" and .key_metrics.hook_chop_selection_source_derived == 1.0 and .key_metrics.hook_chop_static_distance_frames >= 256.0 and .key_metrics.hook_chop_offset_distance_frames >= 512.0) and any(.children[]; .id == "pro_pressure_source_matrix" and .key_metrics.min_dense_hook_chop_static_distance_frames >= 256.0 and .key_metrics.min_dense_hook_chop_offset_distance_frames >= 512.0) and any(.children[]; .id == "professional_source_wav_pack" and .key_metrics.tonal_hook_chop_static_distance_frames >= 256.0 and .key_metrics.tonal_hook_chop_offset_distance_frames >= 512.0)' "{{output}}/professional-output-suite.json"
    jq -e 'any(.children[]; .id == "dense_break" and .key_metrics.destructive_gesture_source_derived == 1.0 and .key_metrics.destructive_static_distance_frames >= 256.0 and .key_metrics.destructive_offset_distance_frames >= 512.0) and any(.children[]; .id == "pro_pressure_source_matrix" and .key_metrics.min_dense_destructive_static_distance_frames >= 256.0 and .key_metrics.min_dense_destructive_offset_distance_frames >= 512.0) and any(.children[]; .id == "professional_source_wav_pack" and .key_metrics.tonal_destructive_static_distance_frames >= 256.0 and .key_metrics.tonal_destructive_offset_distance_frames >= 512.0)' "{{output}}/professional-output-suite.json"
    jq -e 'any(.children[]; .id == "pro_pressure_source_matrix" and .key_metrics.min_sparse_bass_movement_static_distance_hz >= 0.25 and .key_metrics.min_sparse_bass_movement_frequency_span_hz >= 2.0) and any(.children[]; .id == "professional_source_wav_pack" and .key_metrics.sparse_bass_movement_static_distance_hz >= 0.25 and .key_metrics.sparse_bass_movement_frequency_span_hz >= 2.0)' "{{output}}/professional-output-suite.json"
    jq -e 'any(.children[]; .id == "pro_pressure_source_matrix" and .key_metrics.arrangement_unique_role_order_signature_count >= 2 and (.key_metrics.arrangement_role_order_signatures | length) >= 2)' "{{output}}/professional-output-suite.json"
    jq -e 'any(.children[]; .id == "dense_break" and .key_metrics.arrangement_role_order_source_derived == 1.0 and .key_metrics.arrangement_role_candidate_count >= 6.0 and .key_metrics.arrangement_scripted_role_distance >= 1.0) and any(.children[]; .id == "pro_pressure_source_matrix" and .key_metrics.min_source_derived_arrangement_role_candidate_count >= 6.0 and .key_metrics.min_source_derived_arrangement_scripted_role_distance >= 1.0) and any(.children[]; .id == "professional_source_wav_pack" and .key_metrics.min_source_derived_arrangement_role_candidate_count >= 6.0 and .key_metrics.min_source_derived_arrangement_scripted_role_distance >= 1.0)' "{{output}}/professional-output-suite.json"
    jq -e 'any(.children[]; .id == "dense_break" and .key_metrics.mix_treatment_source_derived == 1.0 and .key_metrics.mix_treatment_fixed_distance >= 0.08 and .key_metrics.mix_treatment_output_contrast_ratio >= 2.10) and any(.children[]; .id == "pro_pressure_source_matrix" and .key_metrics.min_source_derived_mix_treatment_fixed_distance >= 0.08 and .key_metrics.min_source_derived_mix_treatment_output_contrast_ratio >= 2.10) and any(.children[]; .id == "professional_source_wav_pack" and .key_metrics.min_source_derived_mix_treatment_fixed_distance >= 0.08 and .key_metrics.min_source_derived_mix_treatment_output_contrast_ratio >= 2.10)' "{{output}}/professional-output-suite.json"
    jq -e 'any(.children[]; .id == "dense_break" and .key_metrics.tail_shape_source_derived == 1.0 and .key_metrics.tail_shape_fixed_distance >= 0.20 and .key_metrics.tail_shape_output_contrast_ratio >= 3.00) and any(.children[]; .id == "pro_pressure_source_matrix" and .key_metrics.min_source_derived_tail_shape_fixed_distance >= 0.20 and .key_metrics.min_source_derived_tail_shape_output_contrast_ratio >= 3.00) and any(.children[]; .id == "professional_source_wav_pack" and .key_metrics.min_source_derived_tail_shape_fixed_distance >= 0.20 and .key_metrics.min_source_derived_tail_shape_output_contrast_ratio >= 3.00)' "{{output}}/professional-output-suite.json"
    jq -e 'any(.children[]; .id == "dense_break" and (.key_metrics.strongest_audible_element as $e | ["kick","snare","bass","stab","silence","restore"] | index($e)) and .key_metrics.strongest_audible_element_score >= 1.00 and .key_metrics.strongest_audible_element_margin >= 0.05) and any(.children[]; .id == "pro_pressure_source_matrix" and (.key_metrics.strongest_audible_elements | index("snare")) and (.key_metrics.strongest_audible_elements | index("bass")) and .key_metrics.min_strongest_audible_element_score >= 1.00 and .key_metrics.min_strongest_audible_element_margin >= 0.05) and any(.children[]; .id == "professional_source_wav_pack" and (.key_metrics.strongest_audible_elements | index("stab")) and (.key_metrics.strongest_audible_elements | index("bass")) and .key_metrics.min_strongest_audible_element_score >= 1.00 and .key_metrics.min_strongest_audible_element_margin >= 0.05) and any(.children[]; .id == "edge_source_professional_diagnostics" and (.key_metrics.strongest_audible_elements | index("stab")) and (.key_metrics.strongest_audible_elements | index("snare")) and .key_metrics.min_strongest_audible_element_score >= 1.00 and .key_metrics.min_strongest_audible_element_margin >= 0.05)' "{{output}}/professional-output-suite.json"
    jq -e 'any(.children[]; .id == "dense_break" and .key_metrics.rebuild_only_source_spectral_similarity >= 0.60 and .key_metrics.rebuild_only_source_transient_retention >= 0.45 and .key_metrics.rebuild_only_source_character_survival_score >= 0.70) and any(.children[]; .id == "pro_pressure_source_matrix" and .key_metrics.min_rebuild_only_source_spectral_similarity >= 0.60 and .key_metrics.min_rebuild_only_source_transient_retention >= 0.45 and .key_metrics.min_rebuild_only_source_character_survival_score >= 0.70) and any(.children[]; .id == "professional_source_wav_pack" and .key_metrics.min_rebuild_only_source_spectral_similarity >= 0.60 and .key_metrics.min_rebuild_only_source_transient_retention >= 0.45 and .key_metrics.min_rebuild_only_source_character_survival_score >= 0.70) and any(.children[]; .id == "edge_source_professional_diagnostics" and .key_metrics.min_rebuild_only_source_spectral_similarity >= 0.60 and .key_metrics.min_rebuild_only_source_transient_retention >= 0.45 and .key_metrics.min_rebuild_only_source_character_survival_score >= 0.70)' "{{output}}/professional-output-suite.json"
    jq -e 'any(.children[]; .id == "pro_pressure_source_matrix" and .key_metrics.min_rebuild_only_to_full_rms_ratio >= 0.42 and .key_metrics.max_rebuild_only_to_source_correlation <= 0.92) and any(.children[]; .id == "professional_source_wav_pack" and .key_metrics.min_rebuild_only_to_full_rms_ratio >= 0.42)' "{{output}}/professional-output-suite.json"
    test -s "{{output}}/README.md"; test -s "{{output}}/professional-output-listening-pack/reviews/dense_beat03_130/review.json"; test -s "{{output}}/destructive-variation/destructive-variation.json"; test -s "{{output}}/rendered-weak-professional-outputs/rendered-weak-professional-outputs.json"; test -s "{{output}}/non-dense-professional-proof-pack/non-dense-professional-proof-pack.json"; test -s "{{output}}/edge-source-professional-diagnostics/edge-source-professional-diagnostics.json"
...
release-grade-demo-bank-fixtures:
    tmp="$(mktemp)" && python3 scripts/validate_release_grade_demo_bank.py --json-output "$tmp" scripts/fixtures/release_grade_demo_bank/demo_bank_v1.json && jq -e '.schema == "riotbox.release_grade_demo_bank.v1" and .result == "pass" and .entry_count >= 6 and .demo_ready_count >= 2 and .verdict_counts.pass >= 2 and .verdict_counts.weak >= 2 and .verdict_counts.fail >= 1 and .verdict_counts.unverified >= 1 and (.source_families | index("dense_break")) and (.source_families | index("tonal_hook")) and (.source_families | index("sparse_bass_pressure"))' "$tmp" && rm "$tmp"
