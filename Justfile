...
_audio-qa-ci-unlocked:
    ...
    just percussive-force-stage-a-v2-acquisition-batch-v2-contract-fixtures
...
percussive-force-stage-a-v2-contract-fixtures:
    ...
    python3 scripts/percussive_force_stage_a_v2_acquisition_contract.py --check
    python3 scripts/validate_percussive_force_stage_a_v2_acquisition_batch.py
    python3 scripts/validate_percussive_force_stage_a_v2_acquisition_batch_fixtures.py
    python3 scripts/percussive_force_stage_a_v2_acquisition_fixtures.py
    python3 scripts/validate_percussive_force_stage_a_v2_acquisition_artifacts_fixtures.py
    python3 scripts/run_percussive_force_stage_a_v2_acquisition_fixtures.py

percussive-force-stage-a-v2-acquisition-once:
    python3 scripts/run_percussive_force_stage_a_v2_acquisition.py

percussive-force-stage-a-v2-acquisition-reconcile-without-network:
    python3 scripts/run_percussive_force_stage_a_v2_acquisition.py --reconcile-publication-without-network

percussive-force-stage-a-v2-acquisition-terminal-validator:
    python3 scripts/validate_percussive_force_stage_a_v2_acquisition_artifacts.py

percussive-force-stage-a-v2-acquisition-batch-v2-contract-fixtures:
    python3 scripts/percussive_force_stage_a_v2_acquisition_batch_v2_contract.py --check
    python3 scripts/validate_percussive_force_stage_a_v2_acquisition_batch_v2.py
    python3 scripts/validate_percussive_force_stage_a_v2_acquisition_batch_v2_fixtures.py
    python3 scripts/validate_percussive_force_stage_a_v2_acquisition_batch_v2_artifacts_fixtures.py
    python3 scripts/run_percussive_force_stage_a_v2_acquisition_batch_v2_fixtures.py

percussive-force-stage-a-v2-acquisition-batch-v2-once:
    python3 scripts/run_percussive_force_stage_a_v2_acquisition_batch_v2.py

percussive-force-stage-a-v2-acquisition-batch-v2-reconcile-without-network:
    python3 scripts/run_percussive_force_stage_a_v2_acquisition_batch_v2.py --reconcile-publication-without-network

percussive-force-stage-a-v2-acquisition-batch-v2-terminal-validator:
    python3 scripts/validate_percussive_force_stage_a_v2_acquisition_batch_v2_artifacts.py
