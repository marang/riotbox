...
sound-quality-readiness-report-smoke output="artifacts/audio_qa/local-sound-quality-readiness-report":
    ...
    python3 scripts/generate_sound_quality_readiness_report.py --weak-routing "{{output}}/weak-output/weak-output-fix-routing.json" --perform-risk-cue-contract "{{output}}/jam-perform-risk-cue-contract/jam-perform-risk-cue-contract.json" --human-review-queue "{{output}}/human-review-queue/release-demo-human-review-queue.json" --output "{{output}}" --date "local-sound-quality-readiness-report"
