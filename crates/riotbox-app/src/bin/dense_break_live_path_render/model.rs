...
pub struct PreparedLivePath {
    ...
    pub cut_hit_return_proof: CutHitReturnProof,
...
pub struct RenderedLivePath {
    ...
    pub cut_hit_return_slam_only_control: RuntimeMixRenderOutput,
    pub cut_hit_return_fill_only_control: RuntimeMixRenderOutput,
    pub cut_hit_return_candidate: RuntimeMixRenderOutput,
    pub cut_hit_return_changed_return: RuntimeMixRenderOutput,
    pub cut_hit_return_callback_partition_invariant: bool,
