...
fn mc202_snapshot_payload_restore_hydrates_phrase_mutation_projection() {
    ...
    let replayed_state = run_snapshot_payload_restore_probe(
        ...
        SnapshotPayloadRestoreSpec {
            ...
            snapshot_label: "after MC-202 instigator before phrase mutation",
            snapshot_created_at: "2026-04-30T16:20:00Z",
            expected_plan_len: 5,
            anchor_plan_len: 4,
            target_plan_index: 4,
            anchor_label: "MC-202 instigator anchor materializes before phrase mutation",
            restore_expectation: "snapshot payload restore applies MC-202 phrase mutation suffix",
        },
        |_| {},
    );
