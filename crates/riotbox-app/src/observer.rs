...
pub fn shell_key_outcome_label(outcome: ShellKeyOutcome) -> &'static str {
    match outcome {
        ...
        ShellKeyOutcome::QueueW30PitchDive => "queue_w30_pitch_dive",
        ShellKeyOutcome::QueueW30FilterSlam => "queue_w30_filter_slam",
        ShellKeyOutcome::QueueW30SilenceCut => "queue_w30_silence_cut",
