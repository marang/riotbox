...
mod manifest_mc202_assertions {
    use super::{
        MC202_PATTERN_ORIGIN_SOURCE_DERIVED_CONTOUR, MC202_PRESSURE_ROLE_WITH_SOURCE_CONTOUR,
        MC202_REASON_SOURCE_GRID_PROOF_RENDERER, MC202_SOURCE_EXPRESSION_ROLE_ANSWER_LIFT,
    ...
    pub(super) fn assert_mc202_manifest(manifest: &serde_json::Value) {
        ...
        assert_eq!(mc202_bass_pressure["source_failure_fallback"], false);
