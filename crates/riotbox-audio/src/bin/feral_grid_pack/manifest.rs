...
struct ManifestPackMetrics {
    ...
    product_stem_drums: ManifestRenderMetrics,
    product_stem_music: ManifestRenderMetrics,
    product_stem_bass: ManifestRenderMetrics,
...
pub(super) fn write_manifest(
    ...
    let manifest = ListeningPackManifest {
        ...
        metrics: ManifestPackMetrics {
            ...
            product_stem_drums: manifest_render_metrics(report.product_stem_drums),
            product_stem_music: manifest_render_metrics(report.product_stem_music),
            product_stem_bass: manifest_render_metrics(report.product_stem_bass),
            product_stem_reconstruction: report.product_stem_reconstruction,
