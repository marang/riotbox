...
pub(super) struct RealtimeTr909RenderState {
    ...
    pub(super) counter_rhythm: Option<Tr909CounterRhythm>,
    pub(super) counter_rhythm_phase: Tr909CounterRhythmPhase,
...
pub(super) struct SharedTr909RenderState {
    ...
    pub(super) counter_rhythm: AtomicU32,
    pub(super) counter_rhythm_phase: AtomicU32,
