...
def validate_access_log_document(
    ...
    *,
    frozen_batch: batch_validator.FrozenAcquisitionBatchV1,
    repo_root: Path,
...
def validate_manifest_document(
    ...
    *,
    ...
    _expect("sealed_manifest.schema_version", document.get("schema_version"), 1)
    _expect("sealed_manifest.contract_bindings", document.get("contract_bindings"), access_log["contract_bindings"])
    ...
    for index, (entry, batch_entry) in enumerate(zip(entries, frozen.document["entries"], strict=True)):
