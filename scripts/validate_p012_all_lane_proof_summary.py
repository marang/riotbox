...
REQUIRED_SNIPPETS = (
    ...
    "| cautious/manual | `needs confirm` | `confirm grid first` | `source_timing` | `source_timing_needs_review_manual_confirm` | `manual_confirm_only` | 0 | 0 | `short_loop_manual_confirm` | 0 | 3 | `compatible` | `partial` | `partial` | `partial` | `partial` | `aligned` | 0 |",
    "| user override | `needs confirm` | `confirm grid first` | `user_override` | `user_override` | `manual_confirm_only` | 0 | 0 | `short_loop_manual_confirm` | 0 | 3 | `compatible` | `partial` | `partial` | `partial` | `partial` | `aligned` | 0 |",
    "| risky override | `needs confirm` | `confirm grid first` | `user_override` | `user_override` | `manual_confirm_only` | 0 | 0 | `short_loop_manual_confirm` | 0 | 3 | `compatible` | `partial` | `partial` | `partial` | `partial` | `aligned` | 0 |",
    "| fallback | `not available` | `timing unavailable` | `static_default` | `source_timing_missing_bpm` | `unavailable` | 0 | 0 | `unavailable` | 0 | 0 | `aligned` | `partial` | `partial` | `partial` | `partial` | `aligned` | 0 |",
    "| locked grid | `grid locked` | `grid can steer moves` | `source_timing` | `source_timing_ready` | `locked_grid` | 16 | 4 | `locked_grid` | 2 | 9 | `aligned` | `aligned` | `aligned` | `aligned` | `aligned` | `aligned` | 0 |",
    ...
    "Generated `Observer beats` and `Observer bars` expose control-path grid evidence",
    "Generated `Phrase count` and `Phrase bars` expose whether each generated path",
    "Generated `Downbeat ambiguity` shows whether the observer and manifest agree",
    "Generated `Anchor alignment` and `Groove alignment` expose whether timing-anchor",
