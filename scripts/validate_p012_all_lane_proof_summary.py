...
REQUIRED_SNIPPETS = (
    ...
    "| cautious/manual | `needs confirm` | `confirm grid first` | `source_timing` | `source_timing_needs_review_manual_confirm` | `manual_confirm_only` | `short_loop_manual_confirm` | 0 | 3 | `compatible` | `partial` | `partial` | `partial` | `partial` | `aligned` | 0 |",
    "| user override | `needs confirm` | `confirm grid first` | `user_override` | `user_override` | `manual_confirm_only` | `short_loop_manual_confirm` | 0 | 3 | `compatible` | `partial` | `partial` | `partial` | `partial` | `aligned` | 0 |",
    "| risky override | `needs confirm` | `confirm grid first` | `user_override` | `user_override` | `manual_confirm_only` | `short_loop_manual_confirm` | 0 | 3 | `compatible` | `partial` | `partial` | `partial` | `partial` | `aligned` | 0 |",
    "| fallback | `not available` | `timing unavailable` | `static_default` | `source_timing_missing_bpm` | `unavailable` | `unavailable` | 0 | 0 | `aligned` | `partial` | `partial` | `partial` | `partial` | `aligned` | 0 |",
    "| locked grid | `grid locked` | `grid can steer moves` | `source_timing` | `source_timing_ready` | `locked_grid` | `locked_grid` | 2 | 9 | `aligned` | `aligned` | `aligned` | `aligned` | `aligned` | `aligned` | 0 |",
