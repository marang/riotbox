...
- widened signal diagnostics across the current local QA outputs, including active/silence ratios, DC offset, onset count, and first grid-aware event-density-per-bar diagnostics for lane recipe and Feral grid outputs
