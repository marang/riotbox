...
- App-level target-suffix QA currently proves this helper can feed downstream TR-909 render projection and source-backed W-30 preview projection from test-owned hydrated anchor state. This is a restore-runner scaffold, not normal app startup behavior.
