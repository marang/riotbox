...
- App-level target-suffix QA currently proves this helper can feed downstream TR-909 render projection from a test-owned hydrated anchor state. This is a restore-runner scaffold, not normal app startup behavior.
