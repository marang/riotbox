...
| W-30 cue path | browse anchor -> trigger suffix, browse anchor -> promoted audition suffix | `crates/riotbox-app/src/jam_app/tests/w30_replay_core.rs`, `w30_replay_snapshot_variants.rs` | committed preview buffer parity and browse-vs-trigger / browse-vs-audition deltas |
| W-30 damage path | browse anchor -> damage-profile suffix | `crates/riotbox-app/src/jam_app/tests/w30_replay_snapshot_variants.rs` | committed grit/preview parity and browse-vs-damage delta |
