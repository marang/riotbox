# `RIOTBOX-590` Map WAV timing probe metrics into preliminary TimingModel diagnostics

- Ticket: `RIOTBOX-590`
- Title: `Map WAV timing probe metrics into preliminary TimingModel diagnostics`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-590`
...
- Branch: ``feature/riotbox-590-map-wav-timing-probe-metrics-into-preliminary-timingmodel``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#581 (https://github.com/marang/riotbox/pull/581)`
- Merge commit: `5964e3c`
