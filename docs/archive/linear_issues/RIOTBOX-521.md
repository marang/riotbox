# `RIOTBOX-521` Run P011 replay/recovery codebase review checkpoint

- Ticket: `RIOTBOX-521`
- Title: `Run P011 replay/recovery codebase review checkpoint`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-521`
...
- Branch: ``feature/riotbox-521-run-p011-replayrecovery-codebase-review-checkpoint``
- Assignee: `Markus`
- Labels: `review-followup, workflow`
- PR: `#511 (https://github.com/marang/riotbox/pull/511)`
- Merge commit: `eabe8c4`
