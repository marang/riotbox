# `RIOTBOX-485` Add recovery notes for snapshot-payload restore limitations

- Ticket: `RIOTBOX-485`
- Title: `Add recovery notes for snapshot-payload restore limitations`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-485`
...
- Branch: ``feature/riotbox-485-add-recovery-notes-for-snapshot-payload-restore-limitations``
- Assignee: `Markus`
- Labels: `review-followup, workflow`
- PR: `#474 (https://github.com/marang/riotbox/pull/474)`
- Merge commit: `9fec6f8`
