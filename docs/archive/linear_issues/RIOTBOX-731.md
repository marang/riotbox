# `RIOTBOX-731` Add markdown output for source timing fixture report

- Ticket: `RIOTBOX-731`
- Title: `Add markdown output for source timing fixture report`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-731`
...
- Branch: `feature/riotbox-731-add-markdown-output-for-source-timing-fixture-report`
- Assignee: `Markus`
