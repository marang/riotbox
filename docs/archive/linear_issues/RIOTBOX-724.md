# `RIOTBOX-724` Use fixture timing tolerances in core evaluator

- Ticket: `RIOTBOX-724`
- Title: `Use fixture timing tolerances in core evaluator`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-724`
...
- Branch: `feature/riotbox-724-use-fixture-timing-tolerances-in-core-evaluator`
- Assignee: `Markus`
