# `RIOTBOX-708` Run periodic P011 codebase review

- Ticket: `RIOTBOX-708`
- Title: `Run periodic P011 codebase review`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-708`
...
- Branch: `feature/riotbox-708-run-periodic-p011-codebase-review`
- Assignee: `Markus`
