# `RIOTBOX-487` Add bounded replay recovery exit checklist

- Ticket: `RIOTBOX-487`
- Title: `Add bounded replay recovery exit checklist`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-487`
...
- Branch: ``feature/riotbox-487-add-bounded-replay-recovery-exit-checklist``
- Assignee: `Markus`
- Labels: `review-followup, workflow`
- PR: `#477 (https://github.com/marang/riotbox/pull/477)`
- Merge commit: `7429cf5`
