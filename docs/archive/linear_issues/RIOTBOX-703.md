# `RIOTBOX-703` Make W-30 side-effect imports explicit

- Ticket: `RIOTBOX-703`
- Title: `Make W-30 side-effect imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-703`
...
- Branch: `feature/riotbox-703-make-w-30-side-effect-imports-explicit`
- Assignee: `Markus`
