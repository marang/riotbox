# `RIOTBOX-512` Surface hydration blockers for supported artifact replay candidates

- Ticket: `RIOTBOX-512`
- Title: `Surface hydration blockers for supported artifact replay candidates`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-512`
...
- Branch: ``feature/riotbox-512-surface-hydration-blockers-for-supported-artifact-replay``
- Assignee: `Markus`
- Labels: `review-followup, ux`
- PR: `#502 (https://github.com/marang/riotbox/pull/502)`
- Merge commit: `b0aa7e7`
