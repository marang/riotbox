# `RIOTBOX-601` Add phrase-grid candidate v0 from stable bar timing evidence

- Ticket: `RIOTBOX-601`
- Title: `Add phrase-grid candidate v0 from stable bar timing evidence`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-601`
...
- Branch: ``feature/riotbox-601-add-phrase-grid-candidate-v0-from-stable-bar-timing-evidence``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#592 (https://github.com/marang/riotbox/pull/592)`
- Merge commit: `6278985`
