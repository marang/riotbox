# `RIOTBOX-574` Tighten P011 exit evidence manifest command validation

- Ticket: `RIOTBOX-574`
- Title: `Tighten P011 exit evidence manifest command validation`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-574`
...
- Branch: ``feature/riotbox-574-tighten-p011-exit-evidence-manifest-command-validation``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#563 (https://github.com/marang/riotbox/pull/563)`
- Merge commit: `ce2f52e`
