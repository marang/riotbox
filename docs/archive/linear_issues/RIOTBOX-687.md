# `RIOTBOX-687` Compare observer and manifest source timing groove evidence in correlation summaries

- Ticket: `RIOTBOX-687`
- Title: `Compare observer and manifest source timing groove evidence in correlation summaries`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-687`
...
- Branch: `feature/riotbox-687-compare-observer-and-manifest-source-timing-groove-evidence`
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `None`
- Merge commit: `None`
...
- Completed slice archived before Linear deletion; PR/merge details remain available from GitHub branch/Linear history.
