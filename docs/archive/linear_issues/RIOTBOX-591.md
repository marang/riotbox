...
- Ticket: `RIOTBOX-591`
- Title: `Add synthetic WAV BPM candidate hypothesis spike`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-591`
...
- Branch: ``feature/riotbox-591-add-synthetic-wav-bpm-candidate-hypothesis-spike``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#582 (https://github.com/marang/riotbox/pull/582)`
- Merge commit: `61899d9`
