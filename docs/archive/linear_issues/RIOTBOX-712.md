# `RIOTBOX-712` Write P011 exit-readiness decision review

- Ticket: `RIOTBOX-712`
- Title: `Write P011 exit-readiness decision review`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-712`
...
- Branch: `feature/riotbox-712-write-p011-exit-readiness-decision-review`
- Assignee: `Markus`
