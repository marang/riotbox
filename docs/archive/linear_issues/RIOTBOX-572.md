# `RIOTBOX-572` Run P011 periodic codebase review after evidence-gate normalization

- Ticket: `RIOTBOX-572`
- Title: `Run P011 periodic codebase review after evidence-gate normalization`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-572`
...
- Branch: ``feature/riotbox-572-run-p011-periodic-codebase-review-after-evidence-gate``
- Assignee: `Markus`
- Labels: `review-followup, workflow`
- PR: `#562 (https://github.com/marang/riotbox/pull/562)`
- Merge commit: `657af65`
