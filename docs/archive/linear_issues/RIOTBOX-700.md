# `RIOTBOX-700` Make scene side-effect imports explicit

- Ticket: `RIOTBOX-700`
- Title: `Make scene side-effect imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-700`
...
- Branch: `feature/riotbox-700-make-scene-side-effect-imports-explicit`
- Assignee: `Markus`
