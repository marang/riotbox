# `RIOTBOX-528` Require valid observer stream evidence in strict audio correlation

- Ticket: `RIOTBOX-528`
- Title: `Require valid observer stream evidence in strict audio correlation`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-528`
...
- Branch: ``feature/riotbox-528-require-valid-observer-stream-evidence-in-strict-audio``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#518 (https://github.com/marang/riotbox/pull/518)`
- Merge commit: `de0e5bd`
