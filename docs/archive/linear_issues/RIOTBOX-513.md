# `RIOTBOX-513` Add recovery guidance for missing snapshot payload candidates

- Ticket: `RIOTBOX-513`
- Title: `Add recovery guidance for missing snapshot payload candidates`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-513`
...
- Branch: ``feature/riotbox-513-add-recovery-guidance-for-missing-snapshot-payload``
- Assignee: `Markus`
- Labels: `review-followup, ux`
- PR: `#503 (https://github.com/marang/riotbox/pull/503)`
- Merge commit: `3299aa2`
