# `RIOTBOX-493` Add W-30 artifact hydration rejection probe

- Ticket: `RIOTBOX-493`
- Title: `Add W-30 artifact hydration rejection probe`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-493`
...
- Branch: ``feature/riotbox-493-add-w-30-artifact-hydration-rejection-probe``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#483 (https://github.com/marang/riotbox/pull/483)`
- Merge commit: `733006a`
