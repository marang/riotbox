# `RIOTBOX-555` Document recovery observer drill coverage matrix

- Ticket: `RIOTBOX-555`
- Title: `Document recovery observer drill coverage matrix`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-555`
...
- Branch: ``feature/riotbox-555-document-recovery-observer-drill-coverage-matrix``
- Assignee: `Markus`
- Labels: `review-followup, workflow`
- PR: `#545 (https://github.com/marang/riotbox/pull/545)`
- Merge commit: `cb1dc8a`
