# `RIOTBOX-678` Run P012 source timing contract codebase review checkpoint

- Ticket: `RIOTBOX-678`
- Title: `Run P012 source timing contract codebase review checkpoint`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-678`
...
- Branch: `feature/riotbox-678-run-p012-source-timing-contract-codebase-review-checkpoint`
- Assignee: `Markus`
- Labels: `timing, review-followup`
- PR: `None`
- Merge commit: `None`
