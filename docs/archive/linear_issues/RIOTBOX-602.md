# `RIOTBOX-602` Expose phrase-grid state in timing candidate confidence report

- Ticket: `RIOTBOX-602`
- Title: `Expose phrase-grid state in timing candidate confidence report`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-602`
...
- Branch: ``feature/riotbox-602-expose-phrase-grid-state-in-timing-candidate-confidence``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#593 (https://github.com/marang/riotbox/pull/593)`
- Merge commit: `c148f05`
