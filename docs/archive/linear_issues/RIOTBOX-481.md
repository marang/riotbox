# `RIOTBOX-481` Surface snapshot payload readiness in restore diagnostics

- Ticket: `RIOTBOX-481`
- Title: `Surface snapshot payload readiness in restore diagnostics`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-481`
...
- Branch: ``feature/riotbox-481-surface-snapshot-payload-readiness-in-restore-diagnostics``
- Assignee: `Markus`
- Labels: `review-followup, ux`
- PR: `#471 (https://github.com/marang/riotbox/pull/471)`
- Merge commit: `abe311b`
