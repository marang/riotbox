# `RIOTBOX-594` Add source timing real-WAV candidate probe fixture seed

- Ticket: `RIOTBOX-594`
- Title: `Add source timing real-WAV candidate probe fixture seed`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-594`
...
- Branch: ``feature/riotbox-594-add-source-timing-real-wav-candidate-probe-fixture-seed``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#587 (https://github.com/marang/riotbox/pull/587)`
- Merge commit: `4666b1c`
