# `RIOTBOX-610` Add Feral grid example guidance for auto versus explicit BPM

- Ticket: `RIOTBOX-610`
- Title: `Add Feral grid example guidance for auto versus explicit BPM`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-610`
...
- Branch: ``feature/riotbox-610-add-feral-grid-example-guidance-for-auto-versus-explicit-bpm``
- Assignee: `Markus`
- Labels: `timing, benchmark, ux`
- PR: `#601 (https://github.com/marang/riotbox/pull/601)`
- Merge commit: `6cc8891`
