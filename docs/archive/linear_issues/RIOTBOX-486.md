# `RIOTBOX-486` Surface payload readiness in manual recovery candidates

- Ticket: `RIOTBOX-486`
- Title: `Surface payload readiness in manual recovery candidates`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-486`
...
- Branch: ``feature/riotbox-486-surface-payload-readiness-in-manual-recovery-candidates``
- Assignee: `Markus`
- Labels: `review-followup, workflow`
- PR: `#476 (https://github.com/marang/riotbox/pull/476)`
- Merge commit: `c6667af`
