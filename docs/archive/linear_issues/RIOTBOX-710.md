# `RIOTBOX-710` Make jam_app recovery imports explicit

- Ticket: `RIOTBOX-710`
- Title: `Make jam_app recovery imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-710`
...
- Branch: `feature/riotbox-710-make-jam_app-recovery-imports-explicit`
- Assignee: `Markus`
