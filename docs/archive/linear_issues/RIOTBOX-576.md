# `RIOTBOX-576` Normalize stage-style stability proof identity across temp runs

- Ticket: `RIOTBOX-576`
- Title: `Normalize stage-style stability proof identity across temp runs`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-576`
...
- Branch: ``feature/riotbox-576-normalize-stage-style-stability-proof-identity-across-temp``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#566 (https://github.com/marang/riotbox/pull/566)`
- Merge commit: `fb8ebce`
