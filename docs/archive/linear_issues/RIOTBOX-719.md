# `RIOTBOX-719` Prove Feral-grid user override observer/audio path

- Ticket: `RIOTBOX-719`
- Title: `Prove Feral-grid user override observer/audio path`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-719`
...
- Branch: `feature/riotbox-719-prove-feral-grid-user-override-observeraudio-path`
- Assignee: `Markus`
