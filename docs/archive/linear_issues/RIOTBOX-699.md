# `RIOTBOX-699` Make jam_app W-30 queue imports explicit

- Ticket: `RIOTBOX-699`
- Title: `Make jam_app W-30 queue imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-699`
...
- Branch: `feature/riotbox-699-make-jam_app-w-30-queue-imports-explicit`
- Assignee: `Markus`
