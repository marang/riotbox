# `RIOTBOX-611` Add real-loop-like timing readiness fixture for drum examples

- Ticket: `RIOTBOX-611`
- Title: `Add real-loop-like timing readiness fixture for drum examples`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-611`
...
- Branch: ``feature/riotbox-611-add-real-loop-like-timing-readiness-fixture-for-drum``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#602 (https://github.com/marang/riotbox/pull/602)`
- Merge commit: `86195b3`
