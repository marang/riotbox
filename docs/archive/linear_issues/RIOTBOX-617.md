# `RIOTBOX-617` Surface source-grid drift in observer/audio correlation summary

- Ticket: `RIOTBOX-617`
- Title: `Surface source-grid drift in observer/audio correlation summary`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-617`
...
- Branch: ``feature/riotbox-617-surface-source-grid-drift-in-observeraudio-correlation``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#608 (https://github.com/marang/riotbox/pull/608)`
- Merge commit: `bcc9803`
