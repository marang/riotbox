# `RIOTBOX-709` Make jam_app state imports explicit

- Ticket: `RIOTBOX-709`
- Title: `Make jam_app state imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-709`
...
- Branch: `feature/riotbox-709-make-jam_app-state-imports-explicit`
- Assignee: `Markus`
