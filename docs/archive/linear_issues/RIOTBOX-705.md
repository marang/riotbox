# `RIOTBOX-705` Make capture artifact imports explicit

- Ticket: `RIOTBOX-705`
- Title: `Make capture artifact imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-705`
...
- Branch: `feature/riotbox-705-make-capture-artifact-imports-explicit`
- Assignee: `Markus`
