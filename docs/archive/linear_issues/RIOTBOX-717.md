# `RIOTBOX-717` Prove Feral-grid static fallback observer/audio path

- Ticket: `RIOTBOX-717`
- Title: `Prove Feral-grid static fallback observer/audio path`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-717`
...
- Branch: `feature/riotbox-717-prove-feral-grid-static-fallback-observeraudio-path`
- Assignee: `Markus`
