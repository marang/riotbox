# `RIOTBOX-689` Use trusted source timing groove residuals in Feral-grid TR-909 support timing

- Ticket: `RIOTBOX-689`
- Title: `Use trusted source timing groove residuals in Feral-grid TR-909 support timing`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-689`
...
- Branch: `feature/riotbox-689-use-trusted-source-timing-groove-residuals-in-feral-grid-tr`
- Assignee: `Markus`
