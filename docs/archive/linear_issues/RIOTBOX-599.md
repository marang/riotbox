# `RIOTBOX-599` Expose source-grid drift in timing candidate confidence report

- Ticket: `RIOTBOX-599`
- Title: `Expose source-grid drift in timing candidate confidence report`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-599`
...
- Branch: ``feature/riotbox-599-expose-source-grid-drift-in-timing-candidate-confidence``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#590 (https://github.com/marang/riotbox/pull/590)`
- Merge commit: `8c29069`
