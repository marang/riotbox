# `RIOTBOX-547` Add TR-909 reinforce scene-lock snapshot restore parity proof

- Ticket: `RIOTBOX-547`
- Title: `Add TR-909 reinforce scene-lock snapshot restore parity proof`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-547`
...
- Branch: ``feature/riotbox-547-add-tr-909-reinforce-scene-lock-snapshot-restore-parity``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#537 (https://github.com/marang/riotbox/pull/537)`
- Merge commit: `ffb073c`
