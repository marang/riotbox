# `RIOTBOX-581` Promote P011 stage-style stability to executable evidence gate

- Ticket: `RIOTBOX-581`
- Title: `Promote P011 stage-style stability to executable evidence gate`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-581`
...
- Branch: ``feature/riotbox-581-promote-p011-stage-style-stability-to-executable-evidence``
- Assignee: `Markus`
- Labels: `benchmark, workflow`
- PR: `#572 (https://github.com/marang/riotbox/pull/572)`
- Merge commit: `7862593`
