# `RIOTBOX-557` Add bounded long-run stage-style stability gate

- Ticket: `RIOTBOX-557`
- Title: `Add bounded long-run stage-style stability gate`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-557`
...
- Branch: ``feature/riotbox-557-add-bounded-long-run-stage-style-stability-gate``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#547 (https://github.com/marang/riotbox/pull/547)`
- Merge commit: `70728f6`
