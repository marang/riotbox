# `RIOTBOX-566` Regenerate representative source examples only after source-diversity gates pass

- Ticket: `RIOTBOX-566`
- Title: `Regenerate representative source examples only after source-diversity gates pass`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-566`
...
- Branch: ``feature/riotbox-566-regenerate-representative-source-examples-only-after-source``
- Assignee: `Markus`
- Labels: `benchmark, workflow`
- PR: `#556 (https://github.com/marang/riotbox/pull/556)`
- Merge commit: `21dddd2`
