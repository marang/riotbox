# `RIOTBOX-704` Make Ghost side-effect imports explicit

- Ticket: `RIOTBOX-704`
- Title: `Make Ghost side-effect imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-704`
...
- Branch: `feature/riotbox-704-make-ghost-side-effect-imports-explicit`
- Assignee: `Markus`
