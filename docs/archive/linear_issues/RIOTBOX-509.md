# `RIOTBOX-509` Add interrupted-save recovery drill fixture

- Ticket: `RIOTBOX-509`
- Title: `Add interrupted-save recovery drill fixture`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-509`
...
- Branch: ``feature/riotbox-509-add-interrupted-save-recovery-drill-fixture``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#499 (https://github.com/marang/riotbox/pull/499)`
- Merge commit: `0ed7b7b`
