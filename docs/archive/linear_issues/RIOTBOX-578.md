# `RIOTBOX-578` Promote P011 exit evidence from index validation toward executable gate coverage

- Ticket: `RIOTBOX-578`
- Title: `Promote P011 exit evidence from index validation toward executable gate coverage`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-578`
...
- Branch: ``feature/riotbox-578-promote-p011-exit-evidence-from-index-validation-toward``
- Assignee: `Markus`
- Labels: `benchmark, workflow`
- PR: `#568 (https://github.com/marang/riotbox/pull/568)`
- Merge commit: `9133cf4`
