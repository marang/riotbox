# `RIOTBOX-651` Add generated source timing probe smoke to audio QA CI

- Ticket: `RIOTBOX-651`
- Title: `Add generated source timing probe smoke to audio QA CI`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-651`
...
- Branch: ``feature/riotbox-651-add-generated-source-timing-probe-smoke-to-audio-qa-ci``
- Assignee: `Markus`
- Labels: `timing, benchmark, workflow`
- PR: `#642 (https://github.com/marang/riotbox/pull/642)`
- Merge commit: `09ed1bb`
...
- Generated ready probe smoke in CI; verified by PR CI.
