# `RIOTBOX-684` Expose source timing groove residual evidence in probe JSON

- Ticket: `RIOTBOX-684`
- Title: `Expose source timing groove residual evidence in probe JSON`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-684`
...
- Branch: `feature/riotbox-684-expose-source-timing-groove-residual-evidence-in-probe-json`
- Assignee: `Markus`
