# `RIOTBOX-506` Replay promote.capture_to_scene for existing captures

- Ticket: `RIOTBOX-506`
- Title: `Replay promote.capture_to_scene for existing captures`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-506`
...
- Branch: ``feature/riotbox-506-replay-promotecapture_to_scene-for-existing-captures``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#496 (https://github.com/marang/riotbox/pull/496)`
- Merge commit: `b942210`
