# `RIOTBOX-715` Use stable needs-review source BPM as cautious grid BPM

- Ticket: `RIOTBOX-715`
- Title: `Use stable needs-review source BPM as cautious grid BPM`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-715`
...
- Branch: `feature/riotbox-715-use-stable-needs-review-source-bpm-as-cautious-grid-bpm`
- Assignee: `Markus`
