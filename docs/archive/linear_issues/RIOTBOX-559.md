# `RIOTBOX-559` Add stage-style snapshot convergence smoke

- Ticket: `RIOTBOX-559`
- Title: `Add stage-style snapshot convergence smoke`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-559`
...
- Branch: ``feature/riotbox-559-add-stage-style-snapshot-convergence-smoke``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#549 (https://github.com/marang/riotbox/pull/549)`
- Merge commit: `525054a`
