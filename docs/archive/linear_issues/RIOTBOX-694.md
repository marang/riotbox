# `RIOTBOX-694` Make jam_app helper imports explicit

- Ticket: `RIOTBOX-694`
- Title: `Make jam_app helper imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-694`
...
- Branch: `feature/riotbox-694-make-jam_app-helper-imports-explicit`
- Assignee: `Markus`
