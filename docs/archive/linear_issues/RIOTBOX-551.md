# `RIOTBOX-551` Add repeated stage-style stability smoke

- Ticket: `RIOTBOX-551`
- Title: `Add repeated stage-style stability smoke`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-551`
...
- Branch: ``feature/riotbox-551-add-repeated-stage-style-stability-smoke``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#541 (https://github.com/marang/riotbox/pull/541)`
- Merge commit: `5dbf3a4`
