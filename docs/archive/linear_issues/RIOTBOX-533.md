...
- Ticket: `RIOTBOX-533`
- Title: `Generate stage-style observer path from an app-level probe`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-533`
...
- Branch: ``feature/riotbox-533-generate-stage-style-observer-path-from-an-app-level-probe``
- Assignee: `Markus`
- Labels: `benchmark`
- PR: `#523 (https://github.com/marang/riotbox/pull/523)`
- Merge commit: `886f1ac`
