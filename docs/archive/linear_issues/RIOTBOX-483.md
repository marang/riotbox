# `RIOTBOX-483` Add app-level snapshot-payload restore failure probes

- Ticket: `RIOTBOX-483`
- Title: `Add app-level snapshot-payload restore failure probes`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-483`
...
- Branch: ``feature/riotbox-483-add-app-level-snapshot-payload-restore-failure-probes``
- Assignee: `Markus`
- Labels: `review-followup, workflow`
- PR: `#473 (https://github.com/marang/riotbox/pull/473)`
- Merge commit: `e7168c7`
