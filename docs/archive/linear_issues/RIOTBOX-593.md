# `RIOTBOX-593` Add source timing candidate confidence report fixture

- Ticket: `RIOTBOX-593`
- Title: `Add source timing candidate confidence report fixture`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-593`
...
- Branch: ``feature/riotbox-593-add-source-timing-candidate-confidence-report-fixture``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#584 (https://github.com/marang/riotbox/pull/584)`
- Merge commit: `dc62232`
