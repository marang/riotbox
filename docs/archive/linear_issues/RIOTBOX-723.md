# `RIOTBOX-723` Add static-default BPM agreement validator fixtures

- Ticket: `RIOTBOX-723`
- Title: `Add static-default BPM agreement validator fixtures`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-723`
...
- Branch: `feature/riotbox-723-add-static-default-bpm-agreement-validator-fixtures`
- Assignee: `Markus`
