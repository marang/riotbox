# `RIOTBOX-706` Make commit pipeline imports explicit

- Ticket: `RIOTBOX-706`
- Title: `Make commit pipeline imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-706`
...
- Branch: `feature/riotbox-706-make-commit-pipeline-imports-explicit`
- Assignee: `Markus`
