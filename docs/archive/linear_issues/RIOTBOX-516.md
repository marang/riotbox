# `RIOTBOX-516` Add recovery observer fixture for app-invalid candidates

- Ticket: `RIOTBOX-516`
- Title: `Add recovery observer fixture for app-invalid candidates`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-516`
...
- Branch: ``feature/riotbox-516-add-recovery-observer-fixture-for-app-invalid-candidates``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#506 (https://github.com/marang/riotbox/pull/506)`
- Merge commit: `c64ea7f`
