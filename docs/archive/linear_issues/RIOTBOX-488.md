# `RIOTBOX-488` Add W-30 snapshot-payload restore parity probe

- Ticket: `RIOTBOX-488`
- Title: `Add W-30 snapshot-payload restore parity probe`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-488`
...
- Branch: ``feature/riotbox-488-add-w-30-snapshot-payload-restore-parity-probe``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#478 (https://github.com/marang/riotbox/pull/478)`
- Merge commit: `6a4edc3`
