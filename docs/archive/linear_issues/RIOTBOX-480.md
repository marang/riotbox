# `RIOTBOX-480` Validate snapshot payload identity on session load

- Ticket: `RIOTBOX-480`
- Title: `Validate snapshot payload identity on session load`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-480`
...
- Branch: ``feature/riotbox-480-validate-snapshot-payload-identity-on-session-load``
- Assignee: `Markus`
- Labels: `review-followup, workflow`
- PR: `#470 (https://github.com/marang/riotbox/pull/470)`
- Merge commit: `bf1bd57`
