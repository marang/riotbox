# `RIOTBOX-686` Add observer source timing groove evidence to user-session snapshots

- Ticket: `RIOTBOX-686`
- Title: `Add observer source timing groove evidence to user-session snapshots`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-686`
...
- Branch: `feature/riotbox-686-add-observer-source-timing-groove-evidence-to-user-session`
- Assignee: `Markus`
