# `RIOTBOX-682` Add first MC-202 phrase-grid timing consumer regression

- Ticket: `RIOTBOX-682`
- Title: `Add first MC-202 phrase-grid timing consumer regression`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-682`
...
- Branch: `feature/riotbox-682-add-first-mc-202-phrase-grid-timing-consumer-regression`
- Assignee: `Markus`
