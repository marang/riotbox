# `RIOTBOX-545` Add graph-aware snapshot restore anchor helper

- Ticket: `RIOTBOX-545`
- Title: `Add graph-aware snapshot restore anchor helper`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-545`
...
- Branch: ``feature/riotbox-545-add-graph-aware-snapshot-restore-anchor-helper``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#535 (https://github.com/marang/riotbox/pull/535)`
- Merge commit: `737256e`
