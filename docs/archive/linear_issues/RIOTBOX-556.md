# `RIOTBOX-556` Add read-only recovery candidate preview affordance

- Ticket: `RIOTBOX-556`
- Title: `Add read-only recovery candidate preview affordance`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-556`
...
- Branch: ``feature/riotbox-556-add-read-only-recovery-candidate-preview-affordance``
- Assignee: `Markus`
- Labels: `review-followup, ux`
- PR: `#546 (https://github.com/marang/riotbox/pull/546)`
- Merge commit: `a72c7ad`
