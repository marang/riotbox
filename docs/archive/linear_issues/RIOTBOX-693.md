# `RIOTBOX-693` Make jam_app lifecycle imports explicit

- Ticket: `RIOTBOX-693`
- Title: `Make jam_app lifecycle imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-693`
...
- Branch: `feature/riotbox-693-make-jam_app-lifecycle-imports-explicit`
- Assignee: `Markus`
- Labels: `review-followup, Improvement`
- PR: `None`
- Merge commit: `None`
