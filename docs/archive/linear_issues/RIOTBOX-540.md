...
- Ticket: `RIOTBOX-540`
- Title: `Migrate W-30 artifact restore probes to shared helper`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-540`
...
- Branch: ``feature/riotbox-540-migrate-w-30-artifact-restore-probes-to-shared-helper``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#530 (https://github.com/marang/riotbox/pull/530)`
- Merge commit: `2203a4f`
