...
- Ticket: `RIOTBOX-589`
- Title: `Add WAV onset-envelope source timing probe scaffold`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-589`
...
- Branch: ``feature/riotbox-589-add-wav-onset-envelope-source-timing-probe-scaffold``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#580 (https://github.com/marang/riotbox/pull/580)`
- Merge commit: `d46c4ce`
