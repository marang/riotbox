# `RIOTBOX-558` Add full-grid export reproducibility smoke

- Ticket: `RIOTBOX-558`
- Title: `Add full-grid export reproducibility smoke`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-558`
...
- Branch: ``feature/riotbox-558-add-full-grid-export-reproducibility-smoke``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#548 (https://github.com/marang/riotbox/pull/548)`
- Merge commit: `08e584f`
