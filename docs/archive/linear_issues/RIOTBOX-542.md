# `RIOTBOX-542` Add MC-202 instigator snapshot-payload restore parity proof

- Ticket: `RIOTBOX-542`
- Title: `Add MC-202 instigator snapshot-payload restore parity proof`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-542`
...
- Branch: ``feature/riotbox-542-add-mc-202-instigator-snapshot-payload-restore-parity-proof``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#532 (https://github.com/marang/riotbox/pull/532)`
- Merge commit: `c00e765`
