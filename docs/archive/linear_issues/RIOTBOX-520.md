# `RIOTBOX-520` Add MC-202 snapshot restore parity probe

- Ticket: `RIOTBOX-520`
- Title: `Add MC-202 snapshot restore parity probe`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-520`
...
- Branch: ``feature/riotbox-520-add-mc-202-snapshot-restore-parity-probe``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#510 (https://github.com/marang/riotbox/pull/510)`
- Merge commit: `1cabed5`
