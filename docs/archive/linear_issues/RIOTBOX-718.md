# `RIOTBOX-718` Tighten source/grid BPM delta consistency in observer summaries

- Ticket: `RIOTBOX-718`
- Title: `Tighten source/grid BPM delta consistency in observer summaries`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-718`
...
- Branch: `feature/riotbox-718-tighten-sourcegrid-bpm-delta-consistency-in-observer`
- Assignee: `Markus`
