# `RIOTBOX-605` Add downbeat phase evidence summary for timing candidates

- Ticket: `RIOTBOX-605`
- Title: `Add downbeat phase evidence summary for timing candidates`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-605`
...
- Branch: ``feature/riotbox-605-add-downbeat-phase-evidence-summary-for-timing-candidates``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#596 (https://github.com/marang/riotbox/pull/596)`
- Merge commit: `8db2f3a`
