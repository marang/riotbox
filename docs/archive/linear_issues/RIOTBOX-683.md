# `RIOTBOX-683` Populate bounded groove residuals for source timing hypotheses

- Ticket: `RIOTBOX-683`
- Title: `Populate bounded groove residuals for source timing hypotheses`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-683`
...
- Branch: `feature/riotbox-683-populate-bounded-groove-residuals-for-source-timing`
- Assignee: `Markus`
