...
- Ticket: `RIOTBOX-525`
- Title: `Expose observer commit-boundary summary in audio correlation`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-525`
...
- Branch: ``feature/riotbox-525-expose-observer-commit-boundary-summary-in-audio-correlation``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#515 (https://github.com/marang/riotbox/pull/515)`
- Merge commit: `ee99b29`
