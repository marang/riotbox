# `RIOTBOX-541` Add MC-202 pressure snapshot-payload restore parity proof

- Ticket: `RIOTBOX-541`
- Title: `Add MC-202 pressure snapshot-payload restore parity proof`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-541`
...
- Branch: ``feature/riotbox-541-add-mc-202-pressure-snapshot-payload-restore-parity-proof``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#531 (https://github.com/marang/riotbox/pull/531)`
- Merge commit: `7d0b43c`
