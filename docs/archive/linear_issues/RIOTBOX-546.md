# `RIOTBOX-546` Document P011 snapshot restore parity coverage matrix

- Ticket: `RIOTBOX-546`
- Title: `Document P011 snapshot restore parity coverage matrix`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-546`
...
- Branch: ``feature/riotbox-546-document-p011-snapshot-restore-parity-coverage-matrix``
- Assignee: `Markus`
- Labels: `review-followup, workflow`
- PR: `#536 (https://github.com/marang/riotbox/pull/536)`
- Merge commit: `b80d1db`
