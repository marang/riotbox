# `RIOTBOX-681` Add first W-30 source-grid chop timing consumer regression

- Ticket: `RIOTBOX-681`
- Title: `Add first W-30 source-grid chop timing consumer regression`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-681`
...
- Branch: `feature/riotbox-681-add-first-w-30-source-grid-chop-timing-consumer-regression`
- Assignee: `Markus`
