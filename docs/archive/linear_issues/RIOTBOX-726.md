# `RIOTBOX-726` Document fixture timing tolerance measurements in benchmark note

- Ticket: `RIOTBOX-726`
- Title: `Document fixture timing tolerance measurements in benchmark note`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-726`
...
- Branch: `feature/riotbox-726-document-fixture-timing-tolerance-measurements-in-benchmark`
- Assignee: `Markus`
