# `RIOTBOX-692` Separate jam_app runtime diagnostics from musician-facing summaries

- Ticket: `RIOTBOX-692`
- Title: `Separate jam_app runtime diagnostics from musician-facing summaries`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-692`
...
- Branch: `feature/riotbox-692-separate-jam_app-runtime-diagnostics-from-musician-facing`
- Assignee: `Markus`
- Labels: `review-followup, TUI, Improvement`
- PR: `None`
- Merge commit: `None`
