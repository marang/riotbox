# `RIOTBOX-518` Add W-30 damage snapshot-payload restore parity probe

- Ticket: `RIOTBOX-518`
- Title: `Add W-30 damage snapshot-payload restore parity probe`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-518`
...
- Branch: ``feature/riotbox-518-add-w-30-damage-snapshot-payload-restore-parity-probe``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#508 (https://github.com/marang/riotbox/pull/508)`
- Merge commit: `7cc1b22`
