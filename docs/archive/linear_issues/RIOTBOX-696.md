# `RIOTBOX-696` Make jam_app transport imports explicit

- Ticket: `RIOTBOX-696`
- Title: `Make jam_app transport imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-696`
...
- Branch: `feature/riotbox-696-make-jam_app-transport-imports-explicit`
- Assignee: `Markus`
