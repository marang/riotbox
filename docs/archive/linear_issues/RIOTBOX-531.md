# `RIOTBOX-531` Add live observer snapshot parity for Recipe 2 probe

- Ticket: `RIOTBOX-531`
- Title: `Add live observer snapshot parity for Recipe 2 probe`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-531`
...
- Branch: ``feature/riotbox-531-add-live-observer-snapshot-parity-for-recipe-2-probe``
- Assignee: `Markus`
- Labels: `benchmark`
- PR: `#521 (https://github.com/marang/riotbox/pull/521)`
- Merge commit: `4987842`
