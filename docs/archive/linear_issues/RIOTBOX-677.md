# `RIOTBOX-677` Document source timing primary warning priority

- Ticket: `RIOTBOX-677`
- Title: `Document source timing primary warning priority`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-677`
...
- Branch: `feature/riotbox-677-document-source-timing-primary-warning-priority`
- Assignee: `Markus`
