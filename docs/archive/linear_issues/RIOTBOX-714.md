...
- Ticket: `RIOTBOX-714`
- Title: `Refine short-loop source timing readiness semantics`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-714`
...
- Branch: `feature/riotbox-714-refine-short-loop-source-timing-readiness-semantics`
- Assignee: `Markus`
- Labels: `timing, ux`
- PR: `None`
- Merge commit: `None`
