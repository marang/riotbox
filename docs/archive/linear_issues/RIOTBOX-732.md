# `RIOTBOX-732` Add source timing fixture report JSON validator fixtures

- Ticket: `RIOTBOX-732`
- Title: `Add source timing fixture report JSON validator fixtures`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-732`
...
- Branch: `feature/riotbox-732-add-source-timing-fixture-report-json-validator-fixtures`
- Assignee: `Markus`
