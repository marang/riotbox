# `RIOTBOX-577` Split next P011 test files that exceed the soft review budget

- Ticket: `RIOTBOX-577`
- Title: `Split next P011 test files that exceed the soft review budget`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-577`
...
- Branch: ``feature/riotbox-577-split-next-p011-test-files-that-exceed-the-soft-review``
- Assignee: `Markus`
- Labels: `review-followup, workflow`
- PR: `#567 (https://github.com/marang/riotbox/pull/567)`
- Merge commit: `3713f5e`
