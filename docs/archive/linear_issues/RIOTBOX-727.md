# `RIOTBOX-727` Make fixture timing evaluation JSON-serializable

- Ticket: `RIOTBOX-727`
- Title: `Make fixture timing evaluation JSON-serializable`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-727`
...
- Branch: `feature/riotbox-727-make-fixture-timing-evaluation-json-serializable`
- Assignee: `Markus`
