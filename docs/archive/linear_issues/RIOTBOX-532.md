...
- Ticket: `RIOTBOX-532`
- Title: `Generate first-playable observer path from an app-level probe`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-532`
...
- Branch: ``feature/riotbox-532-generate-first-playable-observer-path-from-an-app-level``
- Assignee: `Markus`
- Labels: `benchmark`
- PR: `#522 (https://github.com/marang/riotbox/pull/522)`
- Merge commit: `4506e7b`
