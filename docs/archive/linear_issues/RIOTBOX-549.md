# `RIOTBOX-549` Add stage-style restore diversity probe

- Ticket: `RIOTBOX-549`
- Title: `Add stage-style restore diversity probe`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-549`
...
- Branch: ``feature/riotbox-549-add-stage-style-restore-diversity-probe``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#539 (https://github.com/marang/riotbox/pull/539)`
- Merge commit: `6de4ec5`
