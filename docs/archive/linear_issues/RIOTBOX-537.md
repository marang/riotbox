# `RIOTBOX-537` Add shared snapshot restore parity test helper

- Ticket: `RIOTBOX-537`
- Title: `Add shared snapshot restore parity test helper`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-537`
...
- Branch: ``feature/riotbox-537-add-shared-snapshot-restore-parity-test-helper``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#527 (https://github.com/marang/riotbox/pull/527)`
- Merge commit: `d83dfbc`
