# `RIOTBOX-729` Add source timing fixture evaluator JSON report command

- Ticket: `RIOTBOX-729`
- Title: `Add source timing fixture evaluator JSON report command`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-729`
...
- Branch: `feature/riotbox-729-add-source-timing-fixture-evaluator-json-report-command`
- Assignee: `Markus`
