# `RIOTBOX-697` Make jam_app TR-909 queue imports explicit

- Ticket: `RIOTBOX-697`
- Title: `Make jam_app TR-909 queue imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-697`
...
- Branch: `feature/riotbox-697-make-jam_app-tr-909-queue-imports-explicit`
- Assignee: `Markus`
