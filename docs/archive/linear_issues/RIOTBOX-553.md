# `RIOTBOX-553` Add observed interrupted-session recovery drill

- Ticket: `RIOTBOX-553`
- Title: `Add observed interrupted-session recovery drill`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-553`
...
- Branch: ``feature/riotbox-553-add-observed-interrupted-session-recovery-drill``
- Assignee: `Markus`
- Labels: `review-followup, benchmark, ux`
- PR: `#543 (https://github.com/marang/riotbox/pull/543)`
- Merge commit: `7c698d6`
