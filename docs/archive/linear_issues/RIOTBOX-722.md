# `RIOTBOX-722` Add invalid user-override BPM agreement fixtures

- Ticket: `RIOTBOX-722`
- Title: `Add invalid user-override BPM agreement fixtures`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-722`
...
- Branch: `feature/riotbox-722-add-invalid-user-override-bpm-agreement-fixtures`
- Assignee: `Markus`
