# `RIOTBOX-524` Add dedicated stage-style multi-boundary observer fixture

- Ticket: `RIOTBOX-524`
- Title: `Add dedicated stage-style multi-boundary observer fixture`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-524`
...
- Branch: ``feature/riotbox-524-add-dedicated-stage-style-multi-boundary-observer-fixture``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#514 (https://github.com/marang/riotbox/pull/514)`
- Merge commit: `76b3a7c`
