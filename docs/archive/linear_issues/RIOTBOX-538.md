# `RIOTBOX-538` Migrate remaining TR-909 snapshot restore parity probes to helper

- Ticket: `RIOTBOX-538`
- Title: `Migrate remaining TR-909 snapshot restore parity probes to helper`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-538`
...
- Branch: ``feature/riotbox-538-migrate-remaining-tr-909-snapshot-restore-parity-probes-to``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#528 (https://github.com/marang/riotbox/pull/528)`
- Merge commit: `dde7064`
