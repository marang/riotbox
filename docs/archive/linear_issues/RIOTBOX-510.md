# `RIOTBOX-510` Replay capture.bar_group from persisted capture artifact

- Ticket: `RIOTBOX-510`
- Title: `Replay capture.bar_group from persisted capture artifact`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-510`
...
- Branch: ``feature/riotbox-510-replay-capturebar_group-from-persisted-capture-artifact``
- Assignee: `Markus`
- Labels: `review-followup, benchmark`
- PR: `#500 (https://github.com/marang/riotbox/pull/500)`
- Merge commit: `67a2a15`
