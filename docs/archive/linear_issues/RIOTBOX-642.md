# `RIOTBOX-642` Surface source timing trust cue in observer/audio summaries

- Ticket: `RIOTBOX-642`
- Title: `Surface source timing trust cue in observer/audio summaries`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-642`
...
- Branch: ``feature/riotbox-642-surface-source-timing-trust-cue-in-observeraudio-summaries``
- Assignee: `Markus`
- Labels: `timing, benchmark, ux`
- PR: `#633 (https://github.com/marang/riotbox/pull/633)`
- Merge commit: `cfc2635`
...
- Summary trust cue; verified by PR CI.
