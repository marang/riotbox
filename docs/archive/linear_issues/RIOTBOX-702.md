# `RIOTBOX-702` Make TR-909 side-effect imports explicit

- Ticket: `RIOTBOX-702`
- Title: `Make TR-909 side-effect imports explicit`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-702`
...
- Branch: `feature/riotbox-702-make-tr-909-side-effect-imports-explicit`
- Assignee: `Markus`
