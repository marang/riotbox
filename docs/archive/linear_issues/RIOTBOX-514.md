# `RIOTBOX-514` Classify invalid snapshot payload recovery candidates as broken clues

- Ticket: `RIOTBOX-514`
- Title: `Classify invalid snapshot payload recovery candidates as broken clues`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-514`
...
- Branch: ``feature/riotbox-514-classify-invalid-snapshot-payload-recovery-candidates-as``
- Assignee: `Markus`
- Labels: `review-followup, ux`
- PR: `#504 (https://github.com/marang/riotbox/pull/504)`
- Merge commit: `9fcbadf`
