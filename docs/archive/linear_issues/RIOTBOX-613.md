# `RIOTBOX-613` Separate source timing broad and dance-loop readiness policies

- Ticket: `RIOTBOX-613`
- Title: `Separate source timing broad and dance-loop readiness policies`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-613`
...
- Branch: ``feature/riotbox-613-separate-source-timing-broad-and-dance-loop-readiness``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#604 (https://github.com/marang/riotbox/pull/604)`
- Merge commit: `c5e1799`
