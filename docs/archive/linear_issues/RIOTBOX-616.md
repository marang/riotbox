# `RIOTBOX-616` Add source-grid output drift smoke metric for Feral grid packs

- Ticket: `RIOTBOX-616`
- Title: `Add source-grid output drift smoke metric for Feral grid packs`
- Linear issue: `https://linear.app/riotbox/issue/RIOTBOX-616`
...
- Branch: ``feature/riotbox-616-add-source-grid-output-drift-smoke-metric-for-feral-grid``
- Assignee: `Markus`
- Labels: `timing, benchmark`
- PR: `#607 (https://github.com/marang/riotbox/pull/607)`
- Merge commit: `5490ec7`
