...
- current stage-style gate: `just stage-style-jam-probe` exercises a longer generated W-30 source-diff output plus observer/audio correlation; this is a bounded CI probe, not a long-run soak test
